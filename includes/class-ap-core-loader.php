...
class Core_Loader {
  public static function init() {
    // Load core classes
    $classes = [
      'class-ap-cap.php','class-ap-errors.php','class-ap-validator.php',
      'class-ap-rate-limit.php','class-ap-tenant.php','class-ap-hash.php',
      'class-ap-geo.php','class-ap-audit.php'
    ];
    foreach ($classes as $c) require_once AP_CORE_PATH . 'includes/' . $c;
  ...
  public static function register_cpts() {
    register_post_type('ap_tenant', ['label'=>'Studios','public'=>false,'show_ui'=>true,'supports'=>['title'],'menu_icon'=>'dashicons-store']);
    register_post_type('ap_session', ['label'=>'Sessions','public'=>false,'show_ui'=>true,'supports'=>['title','custom-fields'],'menu_icon'=>'dashicons-calendar-alt']);
    register_post_type('ap_contract', ['label'=>'Contracts','public'=>false,'show_ui'=>true,'supports'=>['title','editor','custom-fields'],'menu_icon'=>'dashicons-media-text']);
    register_post_type('ap_invoice', ['label'=>'Invoices','public'=>false,'show_ui'=>true,'supports'=>['title','custom-fields'],'menu_icon'=>'dashicons-clipboard']);
    register_post_type('ap_gallery', ['label'=>'Galleries','public'=>false,'show_ui'=>true,'supports'=>['title','custom-fields'],'menu_icon'=>'dashicons-format-gallery']);
    register_post_type('ap_escalation', ['label'=>'Escalations','public'=>false,'show_ui'=>true,'supports'=>['title','custom-fields'],'menu_icon'=>'dashicons-warning']);
  }

  public static function register_taxonomies() {
    register_taxonomy('ap_tenant_tag',['ap_contract','ap_invoice','ap_gallery','ap_session'],[
  ...
  public static function run_hourly_tasks() {
    ...
    $q = new \WP_Query(['post_type'=>'ap_invoice','meta_query'=>[
      ['key'=>'_ap_status','value'=>'outstanding','compare'=>'=']
    ], 'posts_per_page'=>-1]);
    ...
    $c = new \WP_Query(['post_type'=>'ap_contract','meta_query'=>[
      ['key'=>'_ap_contract_status','value'=>'pending','compare'=>'=']
    ], 'posts_per_page'=>-1]);
